...
public class Settings {
	public static class Colors {
		...
		public static Color findForeground=new Color(Display.getDefault(),220,220,250);
		public static Color findNeg=new Color(Display.getDefault(),255, 0, 0);
		public static Color findNegForeground=new Color(Display.getDefault(),255, 200, 200);
